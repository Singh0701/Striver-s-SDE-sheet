...
// Approach 1: Brute force approach, first sorting the given array then finding all such pairs whose sum is equal to the target sum. and storing it in the ArrayList as arrays are not dynamic in Java, then once we found all such pairs we create an 2d array of same size as arraylist and 2 columns, store all pairs in array and return it.
